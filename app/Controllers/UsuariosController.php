...
class UsuariosController
{
    ...
    public function listar(): void
    {
        ...
        $sql = '
            SELECT 
                ID, NOME, EMAIL, PERFIL, STATUS, CRIADO_EM 
            FROM 
                USUARIOS 
            ORDER BY 
                ID DESC';
        ...
        echo json_encode($usuarios, JSON_PARTIAL_OUTPUT_ON_ERROR | JSON_UNESCAPED_UNICODE);
    }
    ...
    public function criar(): void
    {
        ...
        try {
            $sql = '
                INSERT 
                    INTO USUARIOS (NOME, EMAIL, SENHA, PERFIL, STATUS)
                VALUES
            ...
            echo json_encode([
                'mensagemr'=> 'Usuário cadastrado com sucesso.',
    ...
    public function atualizar(): void
    {
        ...
        if (!$id || $nome === '' || $email === '') {
            http_response_code(400);
            echo json_encode(['error'=> 'ID, nome e e-mail são obrigatórios']);
            return;
        }
