    ...
    try {
        ...
        tbody.innerHTML = atendimentos.map(a => {
            const classeStatus = a.status === 'concluido' ? 'text-bg-success'
                               ...
                               : a.status === 'cancelado' ? 'text-bg-danger'
                               : 'text-bg-primary';
            return `<tr>
                <td>${AtendeLabApi.escape(a.id)}</td>
                <td>${AtendeLabApi.escape(labelRegistro(a, 'pessoa', 'pessoa_nome'))}</td>
                <td>${AtendeLabApi.escape(labelRegistro(a, 'tipo', 'tipo_nome'))}</td>
                <td>${AtendeLabApi.escape(labelRegistro(a, 'responsavel', 'usuario', 'usuario_nome'))}</td>
                <td>${AtendeLabApi.escape(labelRegistro(a, 'data_atendimento', 'data'))}</td>
